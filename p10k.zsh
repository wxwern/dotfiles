# Generated by Powerlevel10k configuration wizard on 2022-09-22 at 19:49 +08.
...
() {
  ...
  if [[ ! "$SESSION_TYPE" =~ ^remote/* ]]; then
    ...
    # nerdfont and powerline unavailable
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=169
